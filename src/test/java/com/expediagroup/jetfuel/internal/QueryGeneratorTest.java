...
public final class QueryGeneratorTest {
    ...
    public void testConstructorNullClient() {
        new QueryGenerator(null, builder.build(), new OrcFileFormatCompressorImpl());
    }

    @Test(expected = NullPointerException.class)
    public void testConstructorNullJetFuelConfiguration() {
        new QueryGenerator(client, null, new OrcFileFormatCompressorImpl());
    }

    @Test
    public void testHiveCompactionSettings() {
        final QueryGenerator queryGenerator = new QueryGenerator(client, builder.build(), new OrcFileFormatCompressorImpl());
    ...
    public void testGenerateJetFuelTextFileCompressionRequest() {
        final JetFuelConfiguration jetFuelConfiguration = builder
                ...
                .build();
        final QueryGenerator queryGenerator = new QueryGenerator(client, jetFuelConfiguration, new TextFileFormatCompressorImpl());
    ...
    public void testGenerateJetFuelSequenceCompressionRequest() {
        final JetFuelConfiguration jetFuelConfiguration = builder
                ...
                .withTargetCompression("GZIP")
                .build();
        final QueryGenerator queryGenerator = new QueryGenerator(client, jetFuelConfiguration, new SeqFileFormatCompressorImpl());
    ...
    public void testGenerateJetFuelRCFileCompressionRequest() {
        final JetFuelConfiguration jetFuelConfiguration = builder
                ...
                .withTargetCompression("GZIP")
                .build();
        final QueryGenerator queryGenerator = new QueryGenerator(client, jetFuelConfiguration, new RcFileFormatCompressorImpl());
